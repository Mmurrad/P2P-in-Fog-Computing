...
OBJS = $O/client.o $O/fog.o $O/server.o
...
clean:
	-rm -rf $O
	-rm -f testproject testproject.exe libtestproject.so libtestproject.a libtestproject.dll libtestproject.dylib
	-rm -f ./*_m.cc ./*_m.h
